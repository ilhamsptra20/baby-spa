        ...
        <nav className="space-y-6 px-3 py-5">
          {menuGroups.map((group) => (
            <section key={group.label}>
              <p
                className={cn(
                  "px-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-400 dark:text-slate-500",
                      ...
                      {hasChildren ? (
                        <>
                          <button
                            ...
                            aria-expanded={sidebarCollapsed ? undefined : isExpanded}
                            aria-controls={sidebarCollapsed ? undefined : `${itemKey}-submenu`}
                            className={cn(
                          ...
                          >
                            ...
                            <span className={cn("min-w-0 flex-1 truncate text-left", sidebarCollapsed && "hidden")}>
                              {item.label}
                            </span>
                        ...
                        >
                          ...
                          <span className={cn("min-w-0 flex-1 truncate", sidebarCollapsed && "hidden")}>
                            {item.label}
                          </span>
